...
std::string LLVMCodeGen::generateIR(ProgramASTNode* program) {
    ...
    fullModule << "; Generated by VIT Compiler (Phase 2)\n";
    fullModule << "; ==========================================================\n\n";
...
void LLVMCodeGen::visit(FunctionDeclASTNode* node) {
    ...
    std::string llvmRetType = (currentFunctionReturnType == "boolean") ? "i1" :
    ...
    for (size_t i = 0; i < params.size(); ++i) {
        std::string pType = (params[i].typeName == "boolean") ? "i1" :
                            (params[i].typeName == "string") ? "i8*" : "double";
    ...
    for (const auto& param : params) {
        ...
        std::string pType = (param.typeName == "boolean") ? "i1" :
                            (param.typeName == "string") ? "i8*" : "double";
        std::string alignStr = (pType == "double") ? "8" : (pType == "i8*") ? "8" : "1";

        emitIndent();
        irStream << addrReg << " = alloca " << pType << ", align " << alignStr << "\n";
        emitIndent();
        irStream << "store " << pType << " %" << param.name << ", " << pType << "* " << addrReg << ", align " << alignStr << "\n";
...
void LLVMCodeGen::visit(VarDeclASTNode* node) {
    ...
    std::string llvmType = (typeName == "boolean") ? "i1" :
                           (typeName == "string") ? "i8*" : "double";
    std::string alignStr = (llvmType == "double") ? "8" : (llvmType == "i8*") ? "8" : "1";

    emitIndent();
    irStream << addrReg << " = alloca " << llvmType << ", align " << alignStr << "\n";
    ...
    if (node->getInitializer()) {
        ...
        emitIndent();
        irStream << "store " << llvmType << " " << valReg << ", " << llvmType << "* " << addrReg << ", align " << alignStr << "\n";
    }
}
...
void LLVMCodeGen::visit(VariableExprASTNode* node) {
    ...
    emitIndent();
    irStream << loadReg << " = load " << llvmType << ", " << llvmType << "* " << addrReg << ", align " << alignStr << "\n";
...
void LLVMCodeGen::visit(CallExprASTNode* node) {
    ...
    std::string llvmRetType = (retType == "boolean") ? "i1" :
                              (retType == "string") ? "i8*" :
                              (retType == "void") ? "void" : "double";
    ...
    for (size_t i = 0; i < argRegs.size(); ++i) {
        std::string pType = (argTypes[i] == "boolean") ? "i1" :
                            (argTypes[i] == "string") ? "i8*" : "double";
